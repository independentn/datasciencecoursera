...
* First the test and train data were combined
* The mean and standard deviation observations were extracted
* Then the activity numbers were changed to labels using activity file
* The column names were added using the features file and their description was changed to be more user friendly
* Finally for each combination of activity and subjet the average of each mean and standard deviation was computed

Final file is saved as tidy_data


## What each variable represents in the raw data
...
## What each variable represents in the tidy data

* subject_number				the subject unique id from 1-30
* activity_description			description of what activity the subject was doing
